...
namespace Munteanu_Bianca_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Munteanu_Bianca_Lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Munteanu_Bianca_Lab2Context context,
